...
class LangchainCompassRetriever(BaseRetriever):
    ...
    """LangchainCompass retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-compass`` and set environment variable
        ``COMPASS_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-compass import LangchainCompassRetriever

            retriever = LangchainCompassRetriever(
                # ...
            )
