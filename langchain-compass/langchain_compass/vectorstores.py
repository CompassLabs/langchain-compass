"""LangchainCompass vector stores."""
...
class LangchainCompassVectorStore(VectorStore):
    # TODO: Replace all TODOs in docstring.
    """LangchainCompass vector store integration.
    ...
    Instantiate:
        .. code-block:: python
            ...
            vector_store = LangchainCompassVectorStore(
                collection_name="foo",
    ...
    @classmethod
    def from_texts(
        cls: Type[LangchainCompassVectorStore],
        texts: List[str],
