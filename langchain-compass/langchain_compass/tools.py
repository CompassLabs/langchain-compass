...
class LangchainCompassToolInput(BaseModel):
    """Input schema for LangchainCompass tool.
...
class LangchainCompassTool(BaseTool):  # type: ignore[override]
    """LangchainCompass tool.
    ...
    args_schema: Type[BaseModel] = LangchainCompassToolInput
