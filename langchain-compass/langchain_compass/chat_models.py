...
class ChatLangchainCompass(BaseChatModel):
    ...
    """LangchainCompass chat model integration.
    ...
    Key init args — completion params:
        model: str
            Name of LangchainCompass model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            LangchainCompass API key. If not passed in will be read from env var COMPASS_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatLangchainCompass.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatLangchainCompass.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatLangchainCompass supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatLangchainCompass supports async generation. Otherwise delete.
