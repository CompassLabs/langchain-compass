"""LangchainCompass document loader."""
...
class LangchainCompassLoader(BaseLoader):
    ...
    """
    LangchainCompass document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import LangchainCompassLoader

            loader = LangchainCompassLoader(
                # required params = ...
                # other params = ...
            )
